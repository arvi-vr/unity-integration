...
#pragma warning restore 649
        ...
        private const string SKIPPED_VERSION_KEY = "ARVI.SDK.SkippedVersion";
        private const string SHOULD_CHECK_UPDATES_KEY = "ARVI.SDK.CheckUpdates";
        ...
        private static void HandleVersionInfoResponse(string data)
        {
            ...
            var skippedVersion = new System.Version(EditorPrefs.GetString(GetSkippedVersionKey(), Integration.Version));
